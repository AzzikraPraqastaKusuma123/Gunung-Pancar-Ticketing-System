...
<head>
    ...
    <style>
        ...
        .ticket-bg {
            ...
            background-image: url('data:image/svg+xml;utf8,<svg viewBox="0 0 800 600" xmlns="http://www.w3.org/2000/svg"><rect width="800" height="600" fill="%230b1f1a"/><path d="M-100,600 L200,250 L450,550 L700,200 L900,450 L900,600 Z" fill="%23143329" opacity="0.8"/><path d="M-50,600 L150,400 L350,580 L550,350 L900,550 L900,600 Z" fill="%231a4235" opacity="0.9"/><circle cx="650" cy="150" r="45" fill="%23d4af37" opacity="0.3"/></svg>');
            background-size: cover;
            background-position: center;
        }

        .dark-overlay {
            background: linear-gradient(105deg, rgba(11, 31, 26, 0.95) 0%, rgba(11, 31, 26, 0.8) 48%, rgba(11, 31, 26, 0.6) 58%, rgba(11, 31, 26, 0) 80%);
        }
...
<body class="flex flex-col items-center justify-center min-h-screen py-10">
    ...
    <div class="no-print mb-8 space-x-4 bg-white p-4 rounded-xl shadow-sm text-center">
        <h2 class="text-xl font-bold mb-2">Semua Tiket Anda</h2>
        <p class="text-slate-500 mb-4 text-sm">Terdapat {{ $booking->tickets->count() }} tiket dalam pesanan ini.</p>
    ...
    <!-- TICKET -->
    <div class="ticket-container relative w-[1000px] h-[450px] flex shadow-xl rounded-2xl overflow-hidden bg-white mb-10">
